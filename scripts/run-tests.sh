...
test_files=(
  "$repo_dir/hammerspoon/fn_music_pause_core_test.lua"
  "$repo_dir/hammerspoon/fn_music_pause_player_test.lua"
  "$repo_dir/hammerspoon/fn_music_pause_config_test.lua"
)
